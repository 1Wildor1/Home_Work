...
namespace Home_Work.Data.Infrastructure.Repository.DI.Implementation
{
    ...
    {
        public static StudentSql UpDate(int id, string name, string lastName, string YearOfStudy)
        {
            return new StudentSql()
            {
                SqlText = $"Update tbl_Student Set FirstName = '{name}', LastName = '{lastName}', YearOfStudy='{YearOfStudy}' where StudentID = {id};",
